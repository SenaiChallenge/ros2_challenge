...
{
  new (message_memory) sensor_interface::srv::SendImage_Request(_init);
}

void SendImage_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sensor_interface::srv::SendImage_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SendImage_Request_message_member_array[1] = {
  {
    ...
    offsetof(sensor_interface::srv::SendImage_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SendImage_Request_message_members = {
  "sensor_interface::srv",  // message namespace
  "SendImage_Request",  // message name
  1,  // number of fields
  sizeof(sensor_interface::srv::SendImage_Request),
...
{
  return &::sensor_interface::srv::rosidl_typesupport_introspection_cpp::SendImage_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_interface, srv, SendImage_Request)() {
  return &::sensor_interface::srv::rosidl_typesupport_introspection_cpp::SendImage_Request_message_type_support_handle;
}
...
void SendImage_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) sensor_interface::srv::SendImage_Response(_init);
}

void SendImage_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sensor_interface::srv::SendImage_Response *>(message_memory);
  typed_message->~SendImage_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SendImage_Response_message_member_array[1] = {
  {
    "cropped",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensor_interface::srv::SendImage_Response, cropped),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SendImage_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(sensor_interface::srv::SendImage_Response),
...
{
  return &::sensor_interface::srv::rosidl_typesupport_introspection_cpp::SendImage_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_interface, srv, SendImage_Response)() {
  return &::sensor_interface::srv::rosidl_typesupport_introspection_cpp::SendImage_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SendImage_service_members = {
  "sensor_interface::srv",  // service namespace
  "SendImage",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<sensor_interface::srv::SendImage>()
...
get_service_type_support_handle<sensor_interface::srv::SendImage>()
{
  ...
  auto service_type_support =
    &::sensor_interface::srv::rosidl_typesupport_introspection_cpp::SendImage_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_interface, srv, SendImage)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<sensor_interface::srv::SendImage>();
}
