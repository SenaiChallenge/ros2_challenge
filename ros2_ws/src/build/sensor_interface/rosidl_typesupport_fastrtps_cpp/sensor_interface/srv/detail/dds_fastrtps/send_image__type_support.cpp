...
#include "sensor_interface/srv/detail/send_image__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_interface::srv::SendImage_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sensor_interface::srv::SendImage_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensor_interface::srv::SendImage_Request *>(
    untyped_ros_message);
...
{
  return &sensor_interface::srv::typesupport_fastrtps_cpp::_SendImage_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = sensor_interface::srv::SendImage_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sensor_interface::srv::SendImage_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<sensor_interface::srv::SendImage_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &sensor_interface::srv::typesupport_fastrtps_cpp::_SendImage_Response__handle;
}
...
{
  return &sensor_interface::srv::typesupport_fastrtps_cpp::_SendImage__handle;
}
